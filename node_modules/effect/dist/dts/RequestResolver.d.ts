 ...
 */
export declare const make: <R, A>(runAll: (requests: Array<Array<A>>) => Effect.Effect<void, never, R>) => RequestResolver<A, R>;
/**
 * Constructs a data source with the specified identifier and method to run
 * requests.
 *
 ...
 * @category constructors
 */
export declare const makeWithEntry: <R, A>(runAll: (requests: Array<Array<Request.Entry<A>>>) => Effect.Effect<void, never, R>) => RequestResolver<A, R>;
/**
 ...
 * @category constructors
 */
export declare const makeBatched: <R, A extends Request.Request<any, any>>(run: (requests: Array<A>) => Effect.Effect<void, never, R>) => RequestResolver<A, R>;
/**
...
export declare const around: {
    <R2, A2, R3, _>(before: Effect.Effect<A2, never, R2>, after: (a: A2) => Effect.Effect<_, never, R3>): <R, A>(self: RequestResolver<A, R>) => RequestResolver<A, R2 | R3 | R>;
    <R, A, R2, A2, R3, _>(self: RequestResolver<A, R>, before: Effect.Effect<A2, never, R2>, after: (a: A2) => Effect.Effect<_, never, R3>): RequestResolver<A, R | R2 | R3>;
};
/**
 * A data source aspect that executes requests between two effects, `before`
 * and `after`, where the result of `before` can be used by `after`.
...
export declare const aroundRequests: {
    <A, R2, A2, R3, _>(before: (requests: ReadonlyArray<Types.NoInfer<A>>) => Effect.Effect<A2, never, R2>, after: (requests: ReadonlyArray<Types.NoInfer<A>>, _: A2) => Effect.Effect<_, never, R3>): <R>(self: RequestResolver<A, R>) => RequestResolver<A, R2 | R3 | R>;
    <R, A, R2, A2, R3, _>(self: RequestResolver<A, R>, before: (requests: ReadonlyArray<Types.NoInfer<A>>) => Effect.Effect<A2, never, R2>, after: (requests: ReadonlyArray<Types.NoInfer<A>>, _: A2) => Effect.Effect<_, never, R3>): RequestResolver<A, R | R2 | R3>;
};
/**
