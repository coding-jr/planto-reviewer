...
/** @internal */
export const invokeWithInterrupt = (self, entries) => core.fiberIdWith(id => core.flatMap(core.flatMap(forkDaemon(core.interruptible(self)), processing => core.async(cb => {
